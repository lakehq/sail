...
Python UDFs (user-defined functions) perform well in Sail. The [PyO3](https://pyo3.rs/) library embeds a Python interpreter in the Sail process. The Arrow format allows zero-copy data sharing between Sail and Python, making your Python code a native part of Sail.
