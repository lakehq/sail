...
<<< @/../python/pysail/tests/spark/datasource/test_python_datasource_read.txt{python-console}

### Batch Arrow Reader

<<< @/../python/pysail/tests/spark/datasource/test_python_datasource_read_arrow.txt{python-console}
