...
/**
 * Check if the Sphinx pages have been generated
 * @returnsTrue if sphinx output folder exists
 */
function hasSphinxPages(): boolean {
  return !!statSync(SPHINX_BUILD_OUTPUT, { throwIfNoEntry: false });
}
