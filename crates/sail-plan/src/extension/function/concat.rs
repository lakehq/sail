/// [Credit]: <https://github.com/apache/datafusion/blob/94d178ebe9674669b32ecd7896b5597f49e90791/datafusion/functions-nested/src/concat.rs>
use std::{any::Any, cmp::Ordering, sync::Arc};

use datafusion::arrow::array::{
    make_array as arrow_make_array, Array, ArrayRef, BooleanBufferBuilder, Capacities,
    GenericListArray, MutableArrayData, OffsetSizeTrait,
};
...
use crate::extension::function::functions_nested_utils::{
    align_array_dimensions, check_datatypes, make_scalar_function,
};
    ...
    i64: TryInto<O>,
{
    ...
    let mut mutable =
        MutableArrayData::with_capacities(vec![&original_data, &element_data], false, capacity);
    ...
    Ok(Arc::new(GenericListArray::<O>::try_new(
        Arc::new(new_list_field(data_type.to_owned(), true)),
