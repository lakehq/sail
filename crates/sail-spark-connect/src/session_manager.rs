...
impl SessionManager {
    ...
    fn create_session_context(
        ...
        let job_runner: Box<dyn JobRunner> = match self.config.deployment {
            DeploymentKind::Local => Box::new(LocalJobRunner::new()),
            DeploymentKind::LocalCluster | DeploymentKind::KubeCluster => {
