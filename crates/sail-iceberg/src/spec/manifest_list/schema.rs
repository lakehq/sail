...
fn manifest_list_schema_v1() -> AvroSchema {
    let fields = vec![
        ...
        record_field("partition_spec_id", AvroSchema::Int, 502, true),
        record_field("added_snapshot_id", AvroSchema::Long, 503, true),
        record_field("added_data_files_count", AvroSchema::Int, 504, false),
        record_field("existing_data_files_count", AvroSchema::Int, 505, false),
        record_field("deleted_data_files_count", AvroSchema::Int, 506, false),
