...
impl From<sail_data_source::options::gen::IcebergWriteOptions> for IcebergWriterExecOptions {
    fn from(opts: sail_data_source::options::gen::IcebergWriteOptions) -> Self {
        Self {
