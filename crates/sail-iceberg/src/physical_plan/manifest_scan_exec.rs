...
///
/// This is the core of the "metadata as data" pattern for Iceberg: instead of eagerly
/// loading all data file metadata on the driver, the manifest scanning is deferred to
/// the physical plan execution phase.
#[derive(Debug)]
