...
pub use schema::{
    df_logical_schema, metadata_struct_field, metadata_struct_fields,
    snapshot_exposes_row_tracking_metadata, METADATA_COLUMN_NAME,
    METADATA_ROW_COMMIT_VERSION_FIELD, METADATA_ROW_ID_FIELD,
};
