...
pub(crate) use op_merge::build_row_level_rewrite_plan as plan_row_level_rewrite;
pub use op_merge::{
    DeltaRowLevelOperation, MergeCommitInfo, MergePredicateInfo, RowLevelTargetInfo,
    RowLevelWriteInfo, build_merge_plan as plan_merge, build_merge_plan_mor as plan_merge_mor,
};
