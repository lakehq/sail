...
pub fn resolve_text_read_options(options: Vec<OptionLayer>) -> DataSourceResult<TableTextOptions> {
...
pub fn resolve_text_write_options(options: Vec<OptionLayer>) -> DataSourceResult<TableTextOptions> {
