...
pub use internal::{
    ...
    DuckLakeReadOptions, DuckLakeWriteOptions, IcebergReadOptions, IcebergWriteOptions,
...
pub(crate) mod internal {
    ...
    include!(concat!(env!("OUT_DIR"), "/options/ducklake_read.rs"));
    include!(concat!(env!("OUT_DIR"), "/options/ducklake_write.rs"));
