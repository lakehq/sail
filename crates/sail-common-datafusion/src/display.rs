...
fn make_formatter<'a>(
    ...
    downcast_primitive_array! {
        ...
        DataType::Struct(_) => {
            ...
            // 2. Both fields are BinaryView type (as generated by VariantArrayBuilder)
            ...
            let is_variant = struct_array.fields().len() == 2
                ...
                && struct_array.fields()[0].data_type() == &DataType::BinaryView
                && struct_array.fields()[1].name() == "value"
                && struct_array.fields()[1].data_type() == &DataType::BinaryView
