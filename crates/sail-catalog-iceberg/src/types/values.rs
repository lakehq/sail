...
pub struct Datum {
    ...
    pub r#type: crate::types::PrimitiveType,
    /// Primitive literal value
    pub literal: PrimitiveLiteral,
}

impl Datum {
    pub fn new(r#type: crate::types::PrimitiveType, literal: PrimitiveLiteral) -> Self {
        Self { r#type, literal }
    }
}
...
impl Literal {
    ...
    pub fn try_into_json(&self, data_type: &crate::types::Type) -> Result<JsonValue, String> {
