        ...
        if mode.is_replace() {
            ...
            match existing {
                ...
                Some(existing_result) => {
                    ...
                    let crate::r#gen::LoadTableResult {
                    ...
                    let mut requirements = vec![crate::r#gen::TableRequirement::AssertTableUuid {
                        uuid: existing_uuid,
                    }];
                    requirements.push(crate::r#gen::TableRequirement::AssertRefSnapshotId {
                        r#ref: MAIN_BRANCH_REF.to_string(),
                        snapshot_id: existing_current_snapshot_id,
                    });
                    if let Some(schema_id) = existing_current_schema_id {
                        requirements.push(crate::r#gen::TableRequirement::AssertCurrentSchemaId {
