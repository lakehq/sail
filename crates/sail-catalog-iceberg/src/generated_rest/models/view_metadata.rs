...
impl ViewMetadata {
    pub fn new(view_uuid: String, format_version: i32, location: String, current_version_id: i32, versions: Vec<models::ViewVersion>, version_log: Vec<models::ViewHistoryEntry>, schemas: Vec<models::Schema>) -> ViewMetadata {
        ViewMetadata {
            view_uuid,
            format_version,
            location,
