...
impl ViewUpdate {
    pub fn new(action: String, uuid: String, format_version: i32, schema: models::Schema, location: String, updates: std::collections::HashMap<String, String>, removals: Vec<String>, view_version: models::ViewVersion, view_version_id: i32) -> ViewUpdate {
        ViewUpdate {
            action,
            uuid,
            format_version,
