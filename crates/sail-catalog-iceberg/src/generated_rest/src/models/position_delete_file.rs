...
pub struct PositionDeleteFile {
    ...
    #[serde(rename = "content-size-in-bytes", skip_serializing_if = "Option::is_none")]
...
impl PositionDeleteFile {
    pub fn new(content: String, file_path: String, file_format: models::FileFormat, spec_id: i32, partition: Vec<models::PrimitiveTypeValue>, file_size_in_bytes: i64, record_count: i64) -> PositionDeleteFile {
        PositionDeleteFile {
            content,
            content_offset: None,
