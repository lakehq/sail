...
impl EqualityDeleteFile {
    pub fn new(content: String, file_path: String, file_format: models::FileFormat, spec_id: i32, partition: Vec<models::PrimitiveTypeValue>, file_size_in_bytes: i64, record_count: i64) -> EqualityDeleteFile {
        EqualityDeleteFile {
            content,
            equality_ids: None,
            file_path,
