...
impl TableUpdate {
    pub fn new(action: String, uuid: String, format_version: i32, schema: models::Schema, schema_id: i32, spec: models::PartitionSpec, spec_id: i32, sort_order: models::SortOrder, sort_order_id: i32, snapshot: models::Snapshot, ref_name: String, r#type: Type, snapshot_id: i64, snapshot_ids: Vec<i64>, location: String, updates: std::collections::HashMap<String, String>, removals: Vec<String>, statistics: models::StatisticsFile, spec_ids: Vec<i32>, schema_ids: Vec<i32>, encryption_key: models::EncryptedKey, key_id: String) -> TableUpdate {
        TableUpdate {
            action,
            uuid,
            format_version,
