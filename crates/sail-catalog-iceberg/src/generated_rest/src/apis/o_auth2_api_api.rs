...
pub trait OAuth2ApiApi: Send + Sync {
    ...
    async fn get_token<'grant_type, 'scope, 'client_id, 'client_secret, 'requested_token_type, 'subject_token, 'subject_token_type, 'actor_token, 'actor_token_type>(&self, grant_type: Option<&'grant_type str>, scope: Option<&'scope str>, client_id: Option<&'client_id str>, client_secret: Option<&'client_secret str>, requested_token_type: Option<models::models::TokenType>, subject_token: Option<&'subject_token str>, subject_token_type: Option<models::models::TokenType>, actor_token: Option<&'actor_token str>, actor_token_type: Option<models::models::TokenType>) -> Result<models::OAuthTokenResponse, Error<GetTokenError>>;
}
