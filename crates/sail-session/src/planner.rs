...
impl QueryPlanner for ExtensionQueryPlanner {
    async fn create_physical_plan(
        ...
        let rewriters: Vec<Box<dyn LogicalRewriter + '_>> =
            vec![Box::new(DeltaMetadataAggregateRewriter::new(session))];
        ...
        logical_plan = sail_plan::function::project_jev_aggregate_arguments(logical_plan)?;
