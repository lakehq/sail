...
impl WorkerPool {
    ...
    pub fn start_worker(&mut self, ctx: &mut ActorContext<DriverActor>) {
        ...
        let options = WorkerLaunchOptions {
            ...
            telemetry_collector_type: self.options.telemetry_collector_type.clone(),
            telemetry_collector_external_host: self
                .options
                .telemetry_collector_external_host
                .clone(),
            telemetry_collector_external_port: self.options.telemetry_collector_external_port,
        };
