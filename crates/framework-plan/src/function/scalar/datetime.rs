...
pub(super) fn list_built_in_datetime_functions() -> Vec<(&'static str, Function)> {
    ...
    vec![
        ...
        ("curdate", F::unknown("curdate")),
        ("current_date", F::unknown("current_date")),
