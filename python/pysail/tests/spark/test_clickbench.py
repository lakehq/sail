...
_CLICKBENCH_SCHEMA = pa.schema(
    [
        ...
        pa.field("EventTime", pa.timestamp("us"), nullable=True),
        pa.field("EventDate", pa.date32(), nullable=True),
        ...
        pa.field("Referer", pa.string(), nullable=True),
        ...
        pa.field("FlashMinor2", pa.string(), nullable=True),
        ...
        pa.field("UserAgentMinor", pa.string(), nullable=True),
        ...
        pa.field("MobilePhoneModel", pa.string(), nullable=True),
        ...
        pa.field("SearchPhrase", pa.string(), nullable=True),
        ...
        pa.field("ClientEventTime", pa.timestamp("us"), nullable=True),
        ...
        pa.field("PageCharset", pa.string(), nullable=True),
        ...
        pa.field("OriginalURL", pa.string(), nullable=True),
        ...
        pa.field("HitColor", pa.string(), nullable=True),
        pa.field("LocalEventTime", pa.timestamp("us"), nullable=True),
        ...
        pa.field("BrowserLanguage", pa.string(), nullable=True),
        pa.field("BrowserCountry", pa.string(), nullable=True),
        pa.field("SocialNetwork", pa.string(), nullable=True),
        pa.field("SocialAction", pa.string(), nullable=True),
        ...
        pa.field("SocialSourcePage", pa.string(), nullable=True),
        pa.field("ParamPrice", pa.int64(), nullable=True),
        pa.field("ParamOrderID", pa.string(), nullable=True),
        pa.field("ParamCurrency", pa.string(), nullable=True),
        pa.field("ParamCurrencyID", pa.int16(), nullable=True),
        pa.field("OpenstatServiceName", pa.string(), nullable=True),
        pa.field("OpenstatCampaignID", pa.string(), nullable=True),
        pa.field("OpenstatAdID", pa.string(), nullable=True),
        pa.field("OpenstatSourceID", pa.string(), nullable=True),
        pa.field("UTMSource", pa.string(), nullable=True),
        pa.field("UTMMedium", pa.string(), nullable=True),
        pa.field("UTMCampaign", pa.string(), nullable=True),
        pa.field("UTMContent", pa.string(), nullable=True),
        pa.field("UTMTerm", pa.string(), nullable=True),
        pa.field("FromTag", pa.string(), nullable=True),
