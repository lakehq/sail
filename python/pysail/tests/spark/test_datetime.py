    ...
    [
        (
            ...
            [
                ...
                (
                    datetime(2024, 11, 3, 17, 30),
                    "2024-11-03 01:30:00",
                    datetime(2024, 11, 3, 17, 30),
                ),  # noqa: DTZ001
                (
                    datetime(2025, 3, 9, 17, 30),
                    "2025-03-09 01:30:00",
                    datetime(2025, 3, 9, 17, 30),
                ),  # noqa: DTZ001
                (
                    datetime(2025, 3, 9, 18, 30),
                    "2025-03-09 03:30:00",
                    datetime(2025, 3, 9, 18, 30),
                ),  # noqa: DTZ001
            ],
        ...
        (
            ...
            [
                ...
                (
                    datetime(2024, 11, 3, 1, 30, fold=0),
                    "2024-11-03 01:30:00",
                    datetime(2024, 11, 3, 1, 30, fold=1),
                ),  # noqa: DTZ001
                (
...
def test_datetime_literal(spark, session_timezone, local_timezone, data):  # noqa: ARG001
    for dt, k, v in data:
        assert spark.range(1).select(lit(dt)).collect() == [
            strict(Row(**{f"TIMESTAMP '{k}'": v}))
        ]
