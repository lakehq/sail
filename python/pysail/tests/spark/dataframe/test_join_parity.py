...
RESULTS = [
    ('on/INNER', 'false', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('on/INNER', 'true', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('using/INNER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('using/INNER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('natural/INNER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('natural/INNER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('on/LEFT OUTER', 'false', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': None, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}"]),
    ('on/LEFT OUTER', 'true', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': None, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}"]),
    ('using/LEFT OUTER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}"]),
    ('using/LEFT OUTER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}"]),
    ('natural/LEFT OUTER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}"]),
    ('natural/LEFT OUTER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}"]),
    ('on/RIGHT OUTER', 'false', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('on/RIGHT OUTER', 'true', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('using/RIGHT OUTER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('using/RIGHT OUTER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('natural/RIGHT OUTER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('natural/RIGHT OUTER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('on/FULL OUTER', 'false', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('on/FULL OUTER', 'true', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': 'y', 'rv': None}", "{'k': None, 'lv': 'z', 'rv': None}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('using/FULL OUTER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': 'z', 'rv': None}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('using/FULL OUTER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': 'z', 'rv': None}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('natural/FULL OUTER', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': 'z', 'rv': None}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ('natural/FULL OUTER', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}", "{'k': 2, 'lv': 'y', 'rv': None}", "{'k': 3, 'lv': None, 'rv': 'q'}", "{'k': None, 'lv': 'z', 'rv': None}", "{'k': None, 'lv': None, 'rv': 'r'}"]),
    ...
    ('on/LEFT ANTI', 'false', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 2, 'lv': 'y'}", "{'k': None, 'lv': 'z'}"]),
    ('on/LEFT ANTI', 'true', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 2, 'lv': 'y'}", "{'k': None, 'lv': 'z'}"]),
    ('using/LEFT ANTI', 'false', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 2, 'lv': 'y'}", "{'k': None, 'lv': 'z'}"]),
    ('using/LEFT ANTI', 'true', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 2, 'lv': 'y'}", "{'k': None, 'lv': 'z'}"]),
    pytest.param(*('on/CROSS', 'false', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]), marks=_SAIL_BUG),
    pytest.param(*('on/CROSS', 'true', ['k', 'lv', 'k', 'rv'], 'struct<k:int,lv:string,k:int,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]), marks=_SAIL_BUG),
    pytest.param(*('using/CROSS', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]), marks=_SAIL_BUG),
    pytest.param(*('using/CROSS', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]), marks=_SAIL_BUG),
    ('key/two keys', 'false', ['a', 'b', 'c', 'd'], 'struct<a:int,b:int,c:int,d:int>', ["{'a': 1, 'b': 2, 'c': 3, 'd': 4}"]),
    ('key/two keys', 'true', ['a', 'b', 'c', 'd'], 'struct<a:int,b:int,c:int,d:int>', ["{'a': 1, 'b': 2, 'c': 3, 'd': 4}"]),
    ('key/key repeated in the clause', 'false', ['k', 'k', 'lv', 'rv'], 'struct<k:int,k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/key repeated in the clause', 'true', ['k', 'k', 'lv', 'rv'], 'struct<k:int,k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/key differing in case', 'false', ['a', 'b', 'c'], 'struct<a:int,b:string,c:string>', ["{'a': 1, 'b': 'p', 'c': 'q'}"]),
    ...
    ('key/self join', 'false', ['k', 'lv', 'lv'], 'struct<k:int,lv:string,lv:string>', ["{'k': 1, 'lv': 'x'}", "{'k': 2, 'lv': 'y'}"]),
    ('key/self join', 'true', ['k', 'lv', 'lv'], 'struct<k:int,lv:string,lv:string>', ["{'k': 1, 'lv': 'x'}", "{'k': 2, 'lv': 'y'}"]),
    ('key/natural self join', 'false', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 1, 'lv': 'x'}", "{'k': 2, 'lv': 'y'}"]),
    ('key/natural self join', 'true', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 1, 'lv': 'x'}", "{'k': 2, 'lv': 'y'}"]),
    ('key/no common name', 'false', ['a', 'b'], 'struct<a:int,b:int>', ["{'a': 1, 'b': 2}"]),
    ('key/no common name', 'true', ['a', 'b'], 'struct<a:int,b:int>', ["{'a': 1, 'b': 2}"]),
    ('key/every name common', 'false', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 1, 'lv': 'x'}", "{'k': 2, 'lv': 'y'}"]),
    ('key/every name common', 'true', ['k', 'lv'], 'struct<k:int,lv:string>', ["{'k': 1, 'lv': 'x'}", "{'k': 2, 'lv': 'y'}"]),
    ...
    pytest.param(*('key/star then qualified key', 'false', ['k', 'lv', 'rv', 'k'], 'struct<k:int,lv:string,rv:string,k:int>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]), marks=_SAIL_BUG),
    pytest.param(*('key/star then qualified key', 'true', ['k', 'lv', 'rv', 'k'], 'struct<k:int,lv:string,rv:string,k:int>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]), marks=_SAIL_BUG),
    ('key/key in a where clause', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/key in a where clause', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ...
    ('key/key in an order by', 'false', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/key in an order by', 'true', ['k', 'lv', 'rv'], 'struct<k:int,lv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/three way using', 'false', ['k', 'lv', 'rv', 'rv'], 'struct<k:int,lv:string,rv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/three way using', 'true', ['k', 'lv', 'rv', 'rv'], 'struct<k:int,lv:string,rv:string,rv:string>', ["{'k': 1, 'lv': 'x', 'rv': 'p'}"]),
    ('key/three way natural', 'false', ['k', 'rv', 'lv'], 'struct<k:int,rv:string,lv:string>', ["{'k': 1, 'rv': 'p', 'lv': 'x'}"]),
    ('key/three way natural', 'true', ['k', 'rv', 'lv'], 'struct<k:int,rv:string,lv:string>', ["{'k': 1, 'rv': 'p', 'lv': 'x'}"]),
    ('key/using then natural', 'false', ['k', 'rv', 'lv'], 'struct<k:int,rv:string,lv:string>', ["{'k': 1, 'rv': 'p', 'lv': 'x'}"]),
    ('key/using then natural', 'true', ['k', 'rv', 'lv'], 'struct<k:int,rv:string,lv:string>', ["{'k': 1, 'rv': 'p', 'lv': 'x'}"]),
]
