...
def test_select_columns_starting_with_col(spark):
...
def test_select_columns_ending_with_name(spark):
...
def test_select_columns_with_numeric_pattern(spark):
...
def test_select_all_columns_wildcard(spark):
...
def test_no_columns_match_returns_empty(spark):
...
def test_no_columns_match_preserves_row_count(spark):
