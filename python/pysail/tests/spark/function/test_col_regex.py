...
class TestColRegex:
    ...
    def test_select_columns_not_starting_with_col1(self, spark_session):
    ...
    def test_select_columns_starting_with_col(self, spark_session):
    ...
    def test_select_columns_ending_with_name(self, spark_session):
    ...
    def test_select_single_column(self, spark_session):
    ...
    def test_select_columns_with_numeric_pattern(self, spark_session):
    ...
    def test_select_all_columns_wildcard(self, spark_session):
    ...
    def test_no_columns_match_returns_empty(self, spark_session):
    ...
    def test_no_columns_match_preserves_row_count(self, spark_session):
        """When no columns match, verify row count is preserved."""
        data = [(1, 2, 3), (4, 5, 6), (7, 8, 9)]
        df = spark_session.createDataFrame(data, ["col1", "col2", "col3"])
        result = df.select(df.colRegex("`nonexistent.*`"))
